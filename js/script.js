...
$(document).ready(function () {
	$(".header-slider").slick({
		prevArrow: '<button class="slick-prev" aria-label="Previous" type="button">Previos</button>',
		nextArrow: '<button class="slick-next" aria-label="Next" type="button">Next</button>',
		arrows: true,
		dots: false,
		adaptiveHeight: true,
...
$(window).on('load resize', function() {
  if ($(window).width() < 500) {
    $('.salt__slider:not(.slick-initialized)').slick({
			prevArrow: '<button class="slick-prev" aria-label="Previous" type="button">Previos</button>',
			nextArrow: '<button class="slick-next" aria-label="Next" type="button">Next</button>',
      dots: false,
			arrows: true,
...
$(document).ready(function () {
	$(".reviews__slider").slick({
		prevArrow: '<button class="slick-prev" aria-label="Previous" type="button"><img src="img/icons/arrow_l.png"/></button>',
		nextArrow: '<button class="slick-next" aria-label="Next" type="button"><img src="img/icons/arrow_r.png"/></button>',
		arrows: true,
		dots: false,
		adaptiveHeight: true,
		slidesToShow: 1,
...
$(window).on('load resize', function() {
  if ($(window).width() < 600) {
    $('.shop__slider:not(.slick-initialized)').slick({
			prevArrow: '<button class="slick-prev" aria-label="Previous" type="button">Previos</button>',
			nextArrow: '<button class="slick-next" aria-label="Next" type="button">Next</button>',
      dots: false,
			arrows: true,
